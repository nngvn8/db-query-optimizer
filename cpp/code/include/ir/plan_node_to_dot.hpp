 ...
 */
void generatePlanDotFile(const PlanNode& root, const std::string& filename, DotContentType contentType = DotContentType::IR_DATA, bool shortColumns = false, bool ignoreFetch = false);
